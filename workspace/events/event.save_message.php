	...
	Class eventsave_message extends Event{
		...
		public static function about(){
			return array(
					 ...
					 'version' => '1.0',
					 'release-date' => '2010-09-27T16:39:13+00:00',
...
&lt;/save-message></code></pre>
  ...
  &lt;/label>
  &lt;label>Message
    &lt;input name="fields[message]" type="text" />
  &lt;/label>
...
&lt;/form></code></pre>
        ...
        <pre class="XML"><code>&lt;input name="redirect" type="hidden" value="http://localhost/nichols/success/" /></code></pre>
